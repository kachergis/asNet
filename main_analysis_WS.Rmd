...
#feather::write_feather(data_growth_net, "saved_data/data_growth_net.feather")
```
...
data_static_pred <- feather::read_feather("saved_data/data_static_pred.feather") 
...
data_growth_pred_WG <- feather::read_feather("saved_data/data_growth_pred_WG.feather")
